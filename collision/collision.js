...
class GameManager {
  constructor(canvas_name) {
    ...
    document.getElementById("maxEnemies").innerHTML = `Max score: ${Math.floor(
      max_enemies
    )}`;
    for (let i = 0; i < max_enemies; i++)
      this.enemies.push(new Enemy(canvas_name));
...
new GameManager("collisionCanvas").run();
